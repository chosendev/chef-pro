...
@section('content')
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-sm-12 text-right">
                        <a href="{{route('staffs.create')}}" style="height: 50px;width: 200px;" class="btn btn-success
                        text-right "
                           type="button"><i
                                class="fa
                        fa-plus"></i>
                ...
                <div class="col-md-4">
                    <div class="panel panel-success">
                        <div class="panel panel-teal"><h2>{{$staff->first_name}}</h2>
    ...
    <center> <?php echo $staffs->render();?></center>
